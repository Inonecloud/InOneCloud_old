...
<article id="main" class="container">	
	...
	<article id="registration">
		...
		<form id="regist" method="post"  onkeyup = "getData()" action="registration/add_user">
			<fieldset id="inputs">
				...
				<input class="password" id="psw" name="password" type="password" placeholder="Password" required pattern="[0-9a-zA-Z]{6,32}" title="Password should have 6 sybols with digits">
				<input class="password" id="cpsw" name="CNFpassword" type="password" placeholder="Repeat password" required onchange = "getData()">
				<select name="lang">
					<option></option>
